...
namespace ZoDream.Repository
{
    public interface IProductRepository
    {
        ...
        /// </summary>
        Task<Page<ProductSimple>> GetAsync(Dictionary<string, string> args, Action<HttpException> action = null);

        Task<Product> GetAsync(int id, Action<HttpException> action = null);

        Task<ResponseData<ProductSimple>> GetRecommendAsync(int id, Action<HttpException> action = null);
        ...
        Task<CommentCount> GetCommentCount(int id, Action<HttpException> action = null);
